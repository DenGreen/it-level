  ...
  return (
    <section className={style.banner}>
      ...
      <div className={style.bannerBox}>
        <span className={`${fonts.cap1.className} ${style.badge}`}>
          КОМПАНИЯ ITLEVEL
        </span>
        <h1 className={`${fonts.headingH3.className} ${style.title}`}>
        ...
        <Btn text={"Отправить заявку"} action={() => window.scrollTo(0, document.body.scrollHeight)} />
      </div>
    </section>
  );
};
